...
public final class EventLibrary implements LibraryExtension {
    ...
    public void extend(ScriptLibrary library) {
        ...
        library.put("onPickup.PreChangeInventory", new EventHandlerFunction<>(ChangeInventoryEvent.Pickup.Pre.class));
        ...
        library.put("onTransfer.PostChangeInventory", new EventHandlerFunction<>(ChangeInventoryEvent.Transfer.Post.class));
        library.put("onTransfer.PreChangeInventory", new EventHandlerFunction<>(ChangeInventoryEvent.Transfer.Pre.class));
        ...
        library.put("onDrag.PrimaryClickInventory", new EventHandlerFunction<>(ClickInventoryEvent.Drag.Primary.class));
        library.put("onDrag.SecondaryClickInventory", new EventHandlerFunction<>(ClickInventoryEvent.Drag.Secondary.class));
        library.put("onDropClickInventory", new EventHandlerFunction<>(ClickInventoryEvent.Drop.class));
        library.put("onDrop.FullClickInventory", new EventHandlerFunction<>(ClickInventoryEvent.Drop.Full.class));
        library.put("onDrop.OutsideClickInventory", new EventHandlerFunction<>(ClickInventoryEvent.Drop.Outside.class));
        library.put("onDrop.Outside.PrimaryClickInventory", new EventHandlerFunction<>(ClickInventoryEvent.Drop.Outside.Primary.class));
        library.put("onDrop.Outside.SecondaryClickInventory", new EventHandlerFunction<>(ClickInventoryEvent.Drop.Outside.Secondary.class));
        library.put("onDrop.SingleClickInventory", new EventHandlerFunction<>(ClickInventoryEvent.Drop.Single.class));
        ...
        library.put("onShift.PrimaryClickInventory", new EventHandlerFunction<>(ClickInventoryEvent.Shift.Primary.class));
        library.put("onShift.SecondaryClickInventory", new EventHandlerFunction<>(ClickInventoryEvent.Shift.Secondary.class));
        ...
        library.put("onScore.ChangeCriterion", new EventHandlerFunction<>(CriterionEvent.Score.Change.class));
        library.put("onScore.GrantCriterion", new EventHandlerFunction<>(AdvancementEvent.Grant.class));
        library.put("onScore.RevokeCriterion", new EventHandlerFunction<>(CriterionEvent.Score.Revoke.class));
        ...
        library.put("onPrimary.MainHandInteractBlock", new EventHandlerFunction<>(InteractBlockEvent.Primary.MainHand.class));
        library.put("onPrimary.OffHandInteractBlock", new EventHandlerFunction<>(InteractBlockEvent.Primary.OffHand.class));
        library.put("onSecondaryInteractBlock", new EventHandlerFunction<>(InteractBlockEvent.Secondary.class));
        library.put("onSecondary.MainHandInteractBlock", new EventHandlerFunction<>(InteractBlockEvent.Secondary.MainHand.class));
        library.put("onSecondary.OffHandInteractBlock", new EventHandlerFunction<>(InteractBlockEvent.Secondary.OffHand.class));
        ...
        library.put("onPrimary.MainHandInteractEntity", new EventHandlerFunction<>(InteractEntityEvent.Primary.MainHand.class));
        library.put("onPrimary.OffHandInteractEntity", new EventHandlerFunction<>(InteractEntityEvent.Primary.OffHand.class));
        library.put("onSecondaryInteractEntity", new EventHandlerFunction<>(InteractEntityEvent.Secondary.class));
        library.put("onSecondary.MainHandInteractEntity", new EventHandlerFunction<>(InteractEntityEvent.Secondary.MainHand.class));
        library.put("onSecondary.OffHandInteractEntity", new EventHandlerFunction<>(InteractEntityEvent.Secondary.OffHand.class));
        ...
        library.put("onPrimary.MainHandInteractItem", new EventHandlerFunction<>(InteractItemEvent.Primary.MainHand.class));
        library.put("onPrimary.OffHandInteractItem", new EventHandlerFunction<>(InteractItemEvent.Primary.OffHand.class));
        library.put("onSecondaryInteractItem", new EventHandlerFunction<>(InteractItemEvent.Secondary.class));
        library.put("onSecondary.MainHandInteractItem", new EventHandlerFunction<>(InteractItemEvent.Secondary.MainHand.class));
        library.put("onSecondary.OffHandInteractItem", new EventHandlerFunction<>(InteractItemEvent.Secondary.OffHand.class));
